          ...
          <div className="max-w-md w-full mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <a href="#recuperar" className="text-sm text-blue-500 font-medium hover:text-blue-700 transition">
            ...
            <div className="mt-10 text-center">
              <p className="text-sm text-slate-500">
                ¿No tienes una cuenta? <a href="#registro" className="text-blue-500 font-medium hover:underline">Regístrate</a>
              </p>
            </div>
          </div>
        </div>
