...
const Dashboard = () => {
  ...
  // Si el usuario es un cliente, podemos mostrar una versión de bienvenida simplificada
  if (user?.rol === 'Cliente') {
    return (
      <div className="bg-white rounded-3xl p-8 border border-slate-200/80 shadow-sm max-w-2xl mx-auto mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 border border-slate-100 rounded-2xl bg-slate-50 hover:bg-blue-50/50 transition-colors">
